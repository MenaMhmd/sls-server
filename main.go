...
//http://localhost:8080/rtc/tester123/publisher/userAccount/fc23490095964d69bd0db22d1bdd9e68/
func init() {
	os.Setenv("APP_ID", "fc23490095964d69bd0db22d1bdd9e68")
	os.Setenv("APP_CERTIFICATE", "1307b779135843deb4379231a37d3ffd")
...
//1307b779135843deb4379231a37d3ffd
